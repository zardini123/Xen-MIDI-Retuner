...
/**
    ...
    Describe your class and how it works here!
                                                                    //[/Comments]
*/
class TransitionCurveEvaluationGraphic  : public juce::Component
{
public:
    //==============================================================================
    TransitionCurveEvaluationGraphic ();
    ~TransitionCurveEvaluationGraphic() override;
...
private:
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TransitionCurveEvaluationGraphic)
};
