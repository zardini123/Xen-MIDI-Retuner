...
TestList::TestList ()
{
    ...
    note_velocity_broadcaster_action.reset (new ActionButtonAndStatus (NOTE_AND_VELOCITY, BROADCASTER));
    addAndMakeVisible (note_velocity_broadcaster_action.get());
    pitch_bend_broadcaster_action.reset (new ActionButtonAndStatus());
    addAndMakeVisible (pitch_bend_broadcaster_action.get());
    channel_aftertouch_broadcaster_action.reset (new ActionButtonAndStatus());
    addAndMakeVisible (channel_aftertouch_broadcaster_action.get());
    control_change_broadcaster_action.reset (new ActionButtonAndStatus());
    addAndMakeVisible (control_change_broadcaster_action.get());
    poly_aftertouch_broadcaster_action.reset (new ActionButtonAndStatus());
    addAndMakeVisible (poly_aftertouch_broadcaster_action.get());
    note_velocity_listener_action.reset (new ActionButtonAndStatus (NOTE_AND_VELOCITY, LISTENER));
    addAndMakeVisible (note_velocity_listener_action.get());
    pitch_bend_listener_action.reset (new ActionButtonAndStatus());
    addAndMakeVisible (pitch_bend_listener_action.get());
    channel_aftertouch_listener_action.reset (new ActionButtonAndStatus());
    addAndMakeVisible (channel_aftertouch_listener_action.get());
    control_change_listener_action.reset (new ActionButtonAndStatus());
    addAndMakeVisible (control_change_listener_action.get());
    poly_aftertouch_listener_action.reset (new ActionButtonAndStatus());
...
//==============================================================================
void TestList::paint (Graphics& g)
{
...
<JUCER_COMPONENT documentType="Component" className="TestList" componentName=""
  ...
  <JUCERCOMP name="" id="8ab3a91cf9f16b4c" memberName="note_velocity_broadcaster_action"
             ...
             constructorParams="NOTE_AND_VELOCITY, BROADCASTER"/>
  ...
  <JUCERCOMP name="" id="3ecb3114d4853cf3" memberName="note_velocity_listener_action"
             ...
             constructorParams="NOTE_AND_VELOCITY, LISTENER"/>
