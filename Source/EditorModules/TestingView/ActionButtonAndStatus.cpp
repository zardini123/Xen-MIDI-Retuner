...
void ActionButtonAndStatus::resized()
{
    ...
    actionButton->setBounds (proportionOfWidth (0.0000f), proportionOfHeight (0.0000f), proportionOfWidth (0.5013f), proportionOfHeight (1.0000f));
    statusBar->setBounds (proportionOfWidth (0.5013f), proportionOfHeight (0.0000f), proportionOfWidth (0.5013f), proportionOfHeight (1.0000f));
...
<JUCER_COMPONENT documentType="Component" className="ActionButtonAndStatus" componentName=""
  ...
  <TEXTBUTTON name="new button" id="747d04c3852ec15e" memberName="actionButton"
              virtualName="" explicitFocusOrder="0" pos="0% 0% 50.095% 100%"
  ...
  <GENERICCOMPONENT name="new component" id="ddfbc579fc8ae26b" memberName="statusBar"
                    virtualName="" explicitFocusOrder="0" pos="50.095% 0% 50.095% 100%"
