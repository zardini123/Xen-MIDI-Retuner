...
CapabilitiesTestGUI::CapabilitiesTestGUI ()
{
    ...
    run_all_tests_for_all_channels.reset (new TextButton ("new button"));
    ...
    listening_header.reset (new Label ("new label",
                                       TRANS("Listening")));
    addAndMakeVisible (listening_header.get());
    listening_header->setFont (Font (15.00f, Font::plain).withTypefaceStyle ("Regular"));
    listening_header->setJustificationType (Justification::centred);
    listening_header->setEditable (false, false, false);
    listening_header->setColour (TextEditor::textColourId, Colours::black);
    listening_header->setColour (TextEditor::backgroundColourId, Colour (0x00000000));

    broadcasting_header.reset (new Label ("new label",
                                          TRANS("Broadcasting")));
    addAndMakeVisible (broadcasting_header.get());
    broadcasting_header->setFont (Font (15.00f, Font::plain).withTypefaceStyle ("Regular"));
    broadcasting_header->setJustificationType (Justification::centred);
    broadcasting_header->setEditable (false, false, false);
    broadcasting_header->setColour (TextEditor::textColourId, Colours::black);
    broadcasting_header->setColour (TextEditor::backgroundColourId, Colour (0x00000000));
    ...
    start_all_test_listeners.reset (new TextButton ("new button"));
    ...
    stop_all_test_listeners.reset (new TextButton ("new button"));
    ...
    timeout_slider.reset (new Slider ("new slider"));
    addAndMakeVisible (timeout_slider.get());
    timeout_slider->setRange (0, 10, 0.01);
    timeout_slider->setSliderStyle (Slider::IncDecButtons);
    timeout_slider->setTextBoxStyle (Slider::TextBoxLeft, false, 80, 20);
    timeout_slider->addListener (this);

    timeout_slider_label.reset (new Label ("new label",
                                           TRANS("Timeout (seconds)")));
    addAndMakeVisible (timeout_slider_label.get());
    timeout_slider_label->setFont (Font (15.00f, Font::plain).withTypefaceStyle ("Regular"));
    timeout_slider_label->setJustificationType (Justification::centredRight);
    timeout_slider_label->setEditable (false, false, false);
    timeout_slider_label->setColour (TextEditor::textColourId, Colours::black);
    timeout_slider_label->setColour (TextEditor::backgroundColourId, Colour (0x00000000));
    ...
    viewport->setViewedComponent (new TestList());
    ...
    start_test_listeners_for_all_channels.reset (new TextButton ("new button"));
    ...
    stop_test_listeners_for_all_channels.reset (new TextButton ("new button"));
    ...
    autostart_all_listeners.reset (new ToggleButton ("new toggle button"));
...
//==============================================================================
void CapabilitiesTestGUI::paint (Graphics& g)
{
...
void CapabilitiesTestGUI::resized()
{
    ...
    run_all_tests_for_all_channels->setBounds (proportionOfWidth (0.7520f) - (proportionOfWidth (0.4500f) / 2), 208, proportionOfWidth (0.4500f), 24);
    ...
    label6->setBounds (0, 96, roundToInt (proportionOfWidth (0.5004f) * 0.5000f), 24);
    label8->setBounds (0 + roundToInt (proportionOfWidth (0.5004f) * 0.4929f), 96, roundToInt (proportionOfWidth (0.5004f) * 0.5000f), 24);
    ...
    label2->setBounds (proportionOfWidth (0.5004f) + 2, 96, roundToInt (proportionOfWidth (0.5004f) * 0.5000f), 24);
    label4->setBounds (proportionOfWidth (0.5004f) + roundToInt (proportionOfWidth (0.5004f) * 0.5000f), 96, roundToInt (proportionOfWidth (0.5004f) * 0.5000f), 24);
    ...
    component2->setBounds (proportionOfWidth (0.7502f) - (proportionOfWidth (0.4500f) / 2), 256, proportionOfWidth (0.4500f), 24);
    component3->setBounds (proportionOfWidth (0.2498f) - (proportionOfWidth (0.4500f) / 2), 256, proportionOfWidth (0.4500f), 24);
    textButton3->setBounds (proportionOfWidth (0.7520f) - (proportionOfWidth (0.4500f) / 2), 280, proportionOfWidth (0.4500f), 24);
    textButton4->setBounds (proportionOfWidth (0.2502f) - proportionOfWidth (0.2246f), 280, proportionOfWidth (0.2246f), 24);
    textButton5->setBounds (proportionOfWidth (0.2502f), 280, proportionOfWidth (0.2246f), 24);
    start_test_listeners_for_all_channels->setBounds (proportionOfWidth (0.2502f) - proportionOfWidth (0.2246f), 208, proportionOfWidth (0.2246f), 24);
    stop_test_listeners_for_all_channels->setBounds (proportionOfWidth (0.2484f), 208, proportionOfWidth (0.2246f), 24);
...
void CapabilitiesTestGUI::buttonClicked (Button* buttonThatWasClicked)
{
...
void CapabilitiesTestGUI::sliderValueChanged (Slider* sliderThatWasMoved)
{
...
<JUCER_COMPONENT documentType="Component" className="CapabilitiesTestGUI" componentName=""
  ...
  <TEXTBUTTON name="new button" id="2f1cdad724c2fbd6" memberName="run_all_tests_for_all_channels"
              virtualName="" explicitFocusOrder="0" pos="75.199%c 208 45.004% 24"
  ...
  <LABEL name="new label" id="417638c1a1b055cd" memberName="listening_header"
         virtualName="" explicitFocusOrder="0" pos="0 24 50.044% 24" edTextCol="ff000000"
  ...
  <LABEL name="new label" id="f6c83cc2f28e8d2c" memberName="broadcasting_header"
         virtualName="" explicitFocusOrder="0" pos="50.044% 24 50.044% 24"
  ...
  <LABEL name="new label" id="bd7a26b3020bbc31" memberName="label8" virtualName=""
         explicitFocusOrder="0" pos="49.293% 96 50% 24" posRelativeX="417638c1a1b055cd"
  ...
  <TEXTBUTTON name="new button" id="d296b21f6b0998bc" memberName="start_all_test_listeners"
              virtualName="" explicitFocusOrder="0" pos="0 304 25.022% 24"
  ...
  <TEXTBUTTON name="new button" id="be54a46ad953004b" memberName="stop_all_test_listeners"
              virtualName="" explicitFocusOrder="0" pos="25.022% 304 25.022% 24"
  ...
  <SLIDER name="new slider" id="a96119be99b37cad" memberName="timeout_slider"
          virtualName="" explicitFocusOrder="0" pos="33.333% 48 16.622% 24"
  ...
  <LABEL name="new label" id="ae317d23d937b427" memberName="timeout_slider_label"
         virtualName="" explicitFocusOrder="0" pos="16.622% 48 16.622% 24"
  ...
  <TEXTBUTTON name="new button" id="3e9ddd45aa807e1f" memberName="run_all_tests"
              virtualName="" explicitFocusOrder="0" pos="50.044% 304 50.044% 24"
  ...
  <JUCERCOMP name="" id="7474405a7e5baa8a" memberName="component2" virtualName=""
             explicitFocusOrder="0" pos="75.022%c 256 45.004% 24" sourceFile="ActionButtonAndStatus.cpp"
             constructorParams=""/>
  <JUCERCOMP name="" id="169daa2f7421393c" memberName="component3" virtualName=""
             explicitFocusOrder="0" pos="24.978%c 256 45.004% 24" sourceFile="ActionButtonAndStatus.cpp"
             constructorParams=""/>
  <TEXTBUTTON name="new button" id="4d3cafa5a7af0c70" memberName="textButton3"
              virtualName="" explicitFocusOrder="0" pos="75.199%c 280 45.004% 24"
  ...
  <TEXTBUTTON name="new button" id="c6a2dbb3329f79a9" memberName="textButton4"
              virtualName="" explicitFocusOrder="0" pos="25.022%r 280 22.458% 24"
  ...
  <TEXTBUTTON name="new button" id="689f5e5be5af45b9" memberName="textButton5"
              virtualName="" explicitFocusOrder="0" pos="25.022% 280 22.458% 24"
  ...
  <TEXTBUTTON name="new button" id="4ada209213d48413" memberName="start_test_listeners_for_all_channels"
              virtualName="" explicitFocusOrder="0" pos="25.022%r 208 22.458% 24"
  ...
  <TEXTBUTTON name="new button" id="89d7c9f26a7005a" memberName="stop_test_listeners_for_all_channels"
              virtualName="" explicitFocusOrder="0" pos="24.845% 208 22.458% 24"
  ...
  <TOGGLEBUTTON name="new toggle button" id="3f487a5b71834efb" memberName="autostart_all_listeners"
                virtualName="" explicitFocusOrder="0" pos="0% 48 16.622% 24"
